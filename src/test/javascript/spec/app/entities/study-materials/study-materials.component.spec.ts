...
import { StudyMaterialsComponent } from 'app/entities/study-materials/study-materials.component';
...
describe('Component Tests', () => {
  describe('StudyMaterials Management Component', () => {
    let comp: StudyMaterialsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StudyMaterialsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.studyMaterials && comp.studyMaterials[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
